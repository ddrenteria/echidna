...
# Mazes to run
mazes = ["Auction", "Crowdfunding", "RockPaperScissors"]
# Test limits to use 
test_limits = [2000000]
...
def get_test_path_base(testLimit, timeout_minutes, seqLen, mazeNumber):
    return f"echidna-test/smart-pulse/seqLen_{seqLen}_timeout_{timeout_minutes}_testLim_{testLimit}/0.5.7/{mazeNumber}"

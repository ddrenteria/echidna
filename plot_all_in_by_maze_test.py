...
def create_data(df_ours, df_og, df_random, ar_our, ar_og, ar_random):
    ar_og.append([float(i) for i in df_og["tests_discovered"]][-1])
    ar_our.append([float(i) for i in df_ours["tests_discovered"]][-1])
    ar_random.append([float(i) for i in df_random["tests_discovered"]][-1])
